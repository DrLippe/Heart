...
var localization = {
    ...
    //abilities
    ab01: ['ドロー','Treasure Magnet','Charmeur'],
    ab02: ['HPプライズアップ','HP Prize Plus','Lebensspende'],
    ab03: ['リンクプライズアップ','Link Prize Plus','Geselligkeit'],
    ab04: ['ラックアップ','Lucky Strike','Glückspilz'],
    ab05: ['HPアップ','HP Boost','Vitalität'],
    ab06: ['ファイアアップ','Fire Boost','Pyromanie'],
    ab07: ['ブリザドアップ','Blizzard Boost','Eiszeit'],
    ab08: ['サンダーアップ','Thunder Boost','Gewitter'],
    ab09: ['ケアルアップ','Cure Boost','Heilkunst'],
    ab10: ['アイテムアップ','Item Boost','Heilkunde'],
    ab11: ['アタックヘイスト','Attack Haste','Attackehast'],
    ab12: ['マジックヘイスト','Magic Haste','Magiehast'],
    ab13: ['コンボFアップ','Combo F Boost','Kombomeister'],
    ab14: ['コマンドFアップ','Finish Boost','Abschlussmeister'],
    ab15: ['ファイアガード','Fire Screen','Feuerfest'],
    ab16: ['ブリザドガード','Blizzard Screen','Frostschutz'],
    ab17: ['サンダーガード','Thunder Screen','Blitzableiter'],
    ab18: ['ダークガード','Dark Screen','Erhellung'],
    ab19: ['リロードブースト','Reload Boost','Notaufladung'],
    ab20: ['ディフェンダー','Defender','Defendor'],
    ab21: ['EXPゼロ','Zero EXP','Null Erfahrung'],
    ab22: ['コンボプラス','Combo Plus','Kombo +'],
    ab23: ['エアコンボプラス','Air Combo Plus','Luftkombo +'],
    ab24: ['EXPチャンス','EXP Chance','Harte Schule'],
    ab25: ['EXPウォーク','EXP Walker','Erfahrungsläufer'],
    ab26: ['ダメージアスピル','Damage Syphon','Esprit'],
    ab27: ['ラストリーヴ','Second Chance','Trotzkopf'],
    ab28: ['コンボリーヴ','Once More','Dickschädel'],
    ab29: ['ライブラ','Scan','Analyse'],
    ab30: ['リーフベール','Leaf Bracer','Immunität'],
}